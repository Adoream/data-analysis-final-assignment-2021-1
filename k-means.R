...
G[which(adult.kmeans.data$race=="Amer-Indian-Eskimo")] <- 2
G[which(adult.kmeans.data$race=="Asian-Pac-Islander")] <- 3
G[which(adult.kmeans.data$race=="White")] <- 4
adult.kmeans.data$race <- NULL
adult.kmeans.data$race <- G
  #sex
G[which(adult.kmeans.data$sex=="Female")] <- 0
G[which(adult.kmeans.data$sex=="Male")] <- 1
